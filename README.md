...
evaluate.py         # Loads a checkpoint, runs evaluation on held-out data
...
python evaluate.py    # evaluates a chosen checkpoint on held-out data
...
Acknowledgements
COWC Dataset — Cars Overhead With Context
